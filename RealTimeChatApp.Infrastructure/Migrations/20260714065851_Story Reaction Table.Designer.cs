...
namespace RealTimeChatApp.Infrastructure.Migrations
{
    ...
    [Migration("20260714065851_Story Reaction Table")]
    partial class StoryReactionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealTimeChatApp.Domain.Models.GroupMessage", b =>
                {
                    ...
                    b.Property<string>("ForwardedFromUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RealTimeChatApp.Domain.Models.Story", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealTimeChatApp.Domain.Models.StoryReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealTimeChatApp.Domain.Models.StoryView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealTimeChatApp.Domain.Models.GroupMessage", b =>
                {
                    b.HasOne("RealTimeChatApp.Domain.Identity.ApplicationUser", "ForwardedFromUser")
                        .WithMany()
            ...
            modelBuilder.Entity("RealTimeChatApp.Domain.Models.StoryReaction", b =>
                {
                    b.HasOne("RealTimeChatApp.Domain.Models.Story", "Story")
                        .WithMany("Reactions")
            ...
            modelBuilder.Entity("RealTimeChatApp.Domain.Models.StoryView", b =>
                {
                    ...
                    b.HasOne("RealTimeChatApp.Domain.Identity.ApplicationUser", "Viewer")
                        .WithMany()
