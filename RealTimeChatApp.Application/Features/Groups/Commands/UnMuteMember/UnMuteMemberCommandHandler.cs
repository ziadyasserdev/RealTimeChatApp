...
{
    public class UnMuteMemberCommandHandler
         : IRequestHandler<UnMuteMemberCommand, Result<string>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ICurrentUserService _currentUser;

        public UnMuteMemberCommandHandler(
            ...
            CancellationToken cancellationToken)
        {
                ...
                currentMember.Role != GroupRole.Admin.ToString())
            {
                return Result<string>.Failure(
                    ResultStatus.Forbidden,
                    "Only owner or admin can unmute members.");
            }
            ...
            if (targetMember.Role == GroupRole.Owner.ToString())
            {
                return Result<string>.Failure(
                    ResultStatus.Forbidden,
                    "The group owner cannot be unmuted.");
            }
            ...
            return Result<string>.Success("Member unmuted successfully.");
        }
    }
}
