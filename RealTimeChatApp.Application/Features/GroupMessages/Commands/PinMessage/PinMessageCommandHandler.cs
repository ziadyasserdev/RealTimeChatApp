...
{
    public class PinGroupMessageCommandHandler
     : IRequestHandler<
         PinGroupMessageCommand,
         Result<MessagePinnedNotifierDto>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ICurrentUserService _currentUser;

        public PinGroupMessageCommandHandler(
        ...
        public async Task<Result<MessagePinnedNotifierDto>> Handle(
            PinGroupMessageCommand request,
            CancellationToken cancellationToken)
        {
            if (!_currentUser.IsAuthenticated)
            {
                return Result<MessagePinnedNotifierDto>.Failure(
            ...
            return Result<MessagePinnedNotifierDto>.Success(
                new MessagePinnedNotifierDto
                {
